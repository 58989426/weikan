...
!function() {
    ...
    h.last = function(n, r, t) {
        if (!(null == n || n.length < 1))
            return null == r || t ? n[n.length - 1] : h.rest(n, Math.max(0, n.length - r))
    }
    ,
    ...
    h.unzip = function(n) {
        for (var r = n && h.max(n, _).length || 0, t = Array(r), e = 0; e < r; e++)
            t[e] = h.pluck(n, e);
        return t
    }
    ,
    ...
    h.memoize = function(e, u) {
        var i = function(n) {
            ...
            return h.has(r, t) || (r[t] = e.apply(this, arguments)),
            r[t]
        };
        return i.cache = {},
        i
    ...
    h.omit = g(function(n, t) {
        ...
        1 < t.length && (r = t[1])) : (t = h.map(S(t, !1, !1), String),
        e = function(n, r) {
    ...
    h.template = function(i, n, r) {
        ...
        var t, e = RegExp([(n.escape || C).source, (n.interpolate || C).source, (n.evaluate || C).source].join("|") + "|$", "g"), o = 0, a = "__p+='";
        i.replace(e, function(n, r, t, e, u) {
            return a += i.slice(o, u).replace(U, V),
            o = u + n.length,
